...
// use crate::core::omnia_types::omnia_types::{OmniaBool, OmniaByte, OmniaChar, OmniaDecimal, OmniaInt, OmniaLong, OmniaString, OmniaUByte, OmniaUInt, OmniaULong, OmniaValue};
...
//                     }
//                     self.scope.set_var(self.name.clone(), (value, *binding.get_right())).expect("")
...
//                 let value = self.value.calc();
//                 if let Some(variable) = self.scope.get_var(self.name.clone()) {
//                     let binding = value.get_type();
//                     let value_type = binding.get_right();
//                     match variable.1 {
//                         Type::BYTE => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_bytes((variable.0.downcast_ref::<OmniaByte>()).unwrap(), &value.downcast_ref::<OmniaByte>().unwrap())), Type::BYTE)) {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_ints((variable.0.downcast_ref::<OmniaInt>()).unwrap(), &value.downcast_ref::<OmniaInt>().unwrap())), Type::INT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::LONG => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_longs((variable.0.downcast_ref::<OmniaLong>()).unwrap(), &value.downcast_ref::<OmniaLong>().unwrap())), Type::LONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::DECIMAL => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_decimals((variable.0.downcast_ref::<OmniaDecimal>()).unwrap(), &value.downcast_ref::<OmniaDecimal>().unwrap())), Type::DECIMAL)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::STRING => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.concat_strings((variable.0.downcast_ref::<OmniaString>()).unwrap(), &value.downcast_ref::<OmniaString>().unwrap())), Type::STRING)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UBYTE => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_ubytes((variable.0.downcast_ref::<OmniaUByte>()).unwrap(), &value.downcast_ref::<OmniaUByte>().unwrap())), Type::UBYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UINT => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_uints((variable.0.downcast_ref::<OmniaUInt>()).unwrap(), &value.downcast_ref::<OmniaUInt>().unwrap())), Type::UINT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::ULONG => {
...
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.plus_assign_ulongs((variable.0.downcast_ref::<OmniaULong>()).unwrap(), &value.downcast_ref::<OmniaULong>().unwrap())), Type::ULONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         _ => {
...
//                                 panic!("Cannot add value of type {:?} to byte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_bytes((variable.0.downcast_ref::<OmniaByte>()).unwrap(), &value.downcast_ref::<OmniaByte>().unwrap())), Type::BYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//
//                         }
...
//                                 panic!("Cannot add value of type {:?} to int value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_ints((variable.0.downcast_ref::<OmniaInt>()).unwrap(), &value.downcast_ref::<OmniaInt>().unwrap())), Type::INT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::LONG => {
...
//                                 panic!("Cannot add value of type {:?} to long value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_longs((variable.0.downcast_ref::<OmniaLong>()).unwrap(), &value.downcast_ref::<OmniaLong>().unwrap())), Type::LONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::DECIMAL => {
...
//                                 panic!("Cannot add value of type {:?} to decimal value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_decimals((variable.0.downcast_ref::<OmniaDecimal>()).unwrap(), &value.downcast_ref::<OmniaDecimal>().unwrap())), Type::DECIMAL)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UBYTE => {
...
//                                 panic!("Cannot add value of type {:?} to ubyte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_ubytes((variable.0.downcast_ref::<OmniaUByte>()).unwrap(), &value.downcast_ref::<OmniaUByte>().unwrap())), Type::UBYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UINT => {
...
//                                 panic!("Cannot add value of type {:?} to uint value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_uints((variable.0.downcast_ref::<OmniaUInt>()).unwrap(), &value.downcast_ref::<OmniaUInt>().unwrap())), Type::UINT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::ULONG => {
...
//                                 panic!("Cannot add value of type {:?} to ulong value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.sub_assign_ulongs((variable.0.downcast_ref::<OmniaULong>()).unwrap(), &value.downcast_ref::<OmniaULong>().unwrap())), Type::ULONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         _ => {
...
//                                 panic!("Cannot add value of type {:?} to byte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_bytes((variable.0.downcast_ref::<OmniaByte>()).unwrap(), &value.downcast_ref::<OmniaByte>().unwrap())), Type::BYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//
//                         }
...
//                                 panic!("Cannot add value of type {:?} to int value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_ints((variable.0.downcast_ref::<OmniaInt>()).unwrap(), &value.downcast_ref::<OmniaInt>().unwrap())), Type::INT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::LONG => {
...
//                                 panic!("Cannot add value of type {:?} to long value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_longs((variable.0.downcast_ref::<OmniaLong>()).unwrap(), &value.downcast_ref::<OmniaLong>().unwrap())), Type::LONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::DECIMAL => {
...
//                                 panic!("Cannot add value of type {:?} to decimal value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_decimals((variable.0.downcast_ref::<OmniaDecimal>()).unwrap(), &value.downcast_ref::<OmniaDecimal>().unwrap())), Type::DECIMAL)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UBYTE => {
...
//                                 panic!("Cannot add value of type {:?} to ubyte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_ubytes((variable.0.downcast_ref::<OmniaUByte>()).unwrap(), &value.downcast_ref::<OmniaUByte>().unwrap())), Type::UBYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UINT => {
...
//                                 panic!("Cannot add value of type {:?} to uint value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_uints((variable.0.downcast_ref::<OmniaUInt>()).unwrap(), &value.downcast_ref::<OmniaUInt>().unwrap())), Type::UINT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::ULONG => {
...
//                                 panic!("Cannot add value of type {:?} to ulong value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.mul_assign_ulongs((variable.0.downcast_ref::<OmniaULong>()).unwrap(), &value.downcast_ref::<OmniaULong>().unwrap())), Type::ULONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         _ => {
...
//                                 panic!("Cannot add value of type {:?} to byte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_bytes((variable.0.downcast_ref::<OmniaByte>()).unwrap(), &value.downcast_ref::<OmniaByte>().unwrap())), Type::BYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//
//                         }
...
//                                 panic!("Cannot add value of type {:?} to int value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_ints((variable.0.downcast_ref::<OmniaInt>()).unwrap(), &value.downcast_ref::<OmniaInt>().unwrap())), Type::INT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::LONG => {
...
//                                 panic!("Cannot add value of type {:?} to long value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_longs((variable.0.downcast_ref::<OmniaLong>()).unwrap(), &value.downcast_ref::<OmniaLong>().unwrap())), Type::LONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::DECIMAL => {
...
//                                 panic!("Cannot add value of type {:?} to decimal value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_decimals((variable.0.downcast_ref::<OmniaDecimal>()).unwrap(), &value.downcast_ref::<OmniaDecimal>().unwrap())), Type::DECIMAL)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UBYTE => {
...
//                                 panic!("Cannot add value of type {:?} to ubyte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_ubytes((variable.0.downcast_ref::<OmniaUByte>()).unwrap(), &value.downcast_ref::<OmniaUByte>().unwrap())), Type::UBYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UINT => {
...
//                                 panic!("Cannot add value of type {:?} to uint value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_uints((variable.0.downcast_ref::<OmniaUInt>()).unwrap(), &value.downcast_ref::<OmniaUInt>().unwrap())), Type::UINT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::ULONG => {
...
//                                 panic!("Cannot add value of type {:?} to ulong value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.div_assign_ulongs((variable.0.downcast_ref::<OmniaULong>()).unwrap(), &value.downcast_ref::<OmniaULong>().unwrap())), Type::ULONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         _ => {
...
//                                 panic!("Cannot add value of type {:?} to byte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_bytes((variable.0.downcast_ref::<OmniaByte>()).unwrap(), &value.downcast_ref::<OmniaByte>().unwrap())), Type::BYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//
//                         }
...
//                                 panic!("Cannot add value of type {:?} to int value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_ints((variable.0.downcast_ref::<OmniaInt>()).unwrap(), &value.downcast_ref::<OmniaInt>().unwrap())), Type::INT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::LONG => {
...
//                                 panic!("Cannot add value of type {:?} to long value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_longs((variable.0.downcast_ref::<OmniaLong>()).unwrap(), &value.downcast_ref::<OmniaLong>().unwrap())), Type::LONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::DECIMAL => {
...
//                                 panic!("Cannot add value of type {:?} to decimal value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_decimals((variable.0.downcast_ref::<OmniaDecimal>()).unwrap(), &value.downcast_ref::<OmniaDecimal>().unwrap())), Type::DECIMAL)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UBYTE => {
...
//                                 panic!("Cannot add value of type {:?} to ubyte value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_ubytes((variable.0.downcast_ref::<OmniaUByte>()).unwrap(), &value.downcast_ref::<OmniaUByte>().unwrap())), Type::UBYTE)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::UINT => {
...
//                                 panic!("Cannot add value of type {:?} to uint value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_uints((variable.0.downcast_ref::<OmniaUInt>()).unwrap(), &value.downcast_ref::<OmniaUInt>().unwrap())), Type::UINT)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         Type::ULONG => {
...
//                                 panic!("Cannot add value of type {:?} to ulong value!", value_type)
//                             }
//                             if let Err(s) = self.scope.set_var(self.name.clone(), (Box::new(self.rem_assign_ulongs((variable.0.downcast_ref::<OmniaULong>()).unwrap(), &value.downcast_ref::<OmniaULong>().unwrap())), Type::ULONG)) {
//                                 panic!("Occurred error while assigning new value to variable {}", self.name)
//                             }
//                         }
//                         _ => {
...
//                 self.scope.set_var(self.name.clone(), (value, *got_type)).expect("")
//             }else {
...
//     scope: Scope,
//     value: Box<dyn OmniaValue>
// }
// impl ValueExpression {
//     pub fn new(scope: Scope, value: Box<dyn OmniaValue>) -> ValueExpression {
//         Self {
//             scope,
//             value
//         }
...
//     pub fn new(name: String, scope: Scope) -> VariableAccessExpression {
//         Self {
//             name,
//             scope
//         }
...
// impl Expression for VariableAccessExpression {
//     fn calc(&mut self) -> Box<dyn OmniaValue> {
//         if let Some(variable) = self.scope.get_var(self.name.clone()) {
//             let (var, var_type) = variable;
//             match var_type {
//                 Type::BYTE => {
//                     Box::new((*var.downcast_ref::<OmniaByte>().unwrap()).clone())
//                 }
//                 Type::INT => {
//                     Box::new((*var.downcast_ref::<OmniaInt>().unwrap()).clone())
//                 }
//                 Type::LONG => {
//                     Box::new((*var.downcast_ref::<OmniaLong>().unwrap()).clone())
//                 }
//                 Type::DECIMAL => {
//                     Box::new((*var.downcast_ref::<OmniaDecimal>().unwrap()).clone())
//                 }
//                 Type::UBYTE => {
//                     Box::new((*var.downcast_ref::<OmniaUByte>().unwrap()).clone())
//                 }
//                 Type::UINT => {
//                     Box::new((*var.downcast_ref::<OmniaUInt>().unwrap()).clone())
//                 }
//                 Type::ULONG => {
//                     Box::new((*var.downcast_ref::<OmniaULong>().unwrap()).clone())
//                 }
//                 Type::BOOL => {
//                     Box::new((*var.downcast_ref::<OmniaBool>().unwrap()).clone())
//                 }
//                 Type::STRING => {
//                     Box::new((*var.downcast_ref::<OmniaString>().unwrap()).clone())
//                 }
//                 Type::CHAR => {
//                     Box::new((*var.downcast_ref::<OmniaChar>().unwrap()).clone())
//                 }
//                 _ => {
//                     panic!("Unexpected or unsupported type {:?}", var_type)
//                 }
//             }
//             // let cl = variable.clone();
//             // let binding = (*cl).clone();
//             // binding.0
//
//         } else {
//             panic!("Variable with name {} not found in this context!", self.name)
